...
import ChatRoomList from './components/ChatComponents/ChatRoomList';
import NewChatRoom from './components/ChatComponents/NewChatRoom';
      ...
      <Router>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/room/new" element={<NewChatRoom/>}/>
